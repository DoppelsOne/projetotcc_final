...
import { Login, PlantDetails, SignUp, RegisterPlant } from './src/routers/controller';
  ...
  return (
    <NavigationContainer>      
      <Stack.Navigator>
        ...
        <Stack.Screen name = "RegisterPlant" component={RegisterPlant} options={{headerShown: false}}/>
      </Stack.Navigator>    
    </NavigationContainer>
  );
};
